...
# Part 4.1 Auto-decrytion mode added
while (mode != "e" and mode != "d" and mode !="a"):
    mode = input("Select encryption mode (press e + enter)," + 
...
# PART 3.1 : Choose to input messgae / read in message from file
...
if input_mode == "f":
    ...
    # PART 3.5 : The program should then continue to work as before
...
if isinstance(output_msg, str):
    print("output msg: \n", output_msg + "\n") 
    # PART 2.2 : After en/decryption print metrics
    # The statistics should be based on the whole message
...
if  file_path == 'douglas_data_encrypted.txt':
    ...
    with open("douglas_data_decrypted.txt", "r") as file:
        ...
        # data = np.genfromtxt("douglas_data_decrypted.txt",
        #                       delimiter = " ")
        
        # print(data['KNOT_RATIO'])
