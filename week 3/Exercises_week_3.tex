...
\begin{Exercise}[title=While Loops]
    ...
    \textbf{Note:} {\tt <?>} is used as a placeholder to represent something missing - this could be an operator, a variable name,function name, etc.  Multiple {\tt <?>} in the same question are not necessarily representing the same thing.
